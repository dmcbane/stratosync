...
**Status**: Pre-alpha (v0.4.0). Phase 1 (read-only VFS) and Phase 2 (bidirectional sync) are implemented and tested with Google Drive. Phase 3+ (delta APIs, desktop integration, selective sync) are not started.
